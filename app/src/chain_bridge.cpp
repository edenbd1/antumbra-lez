...
const char* kSaleAccount     = "gweZAVxdgb2NmveTwf25hQVkueEZdxQEJyUpJgUE8N2";
const char* kPoolAccount     = "25ekuB2nQ84WLvoVjWejf63Z714X9vvjnb7Jz4R3Kkdg";
const char* kScheduleAccount = "SqLgfYnsQ6STtHRvjNxj1MmXjM3EsUBbsCCvDCcpX9B";
...
void ChainBridge::fetch(const QString& label, const QString& accountId) {
    ...
    connect(reply, &QNetworkReply::finished, this, [this, reply, label]() {
        ...
        const QJsonArray raw = result.toObject().value(QStringLiteral("data")).toArray();
        QByteArray data;
        ...
        if (label == QLatin1String("sale")) {
            ...
            emit saleUpdated(vt, vc, sr, rc, seed);
